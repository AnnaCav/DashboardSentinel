...
<form action= "WetterV7.php" method="post" id="myForm">
<label>
...
<form action="WetterV7.php" method="post" id="geolocation">
...
<p id="date" style="font-size:18px; color:white; text-shadow:0 0 3px black;margin-top:0px">
</p>
</div>
<br>
<script>
...
<div id="raincloud">
<img src="cloud.png" alt="Cloud" width="95px">
</div>
<div id="DailyWeather">
<p style="font-size:14px; color:white; text-shadow:0 0 1px black;"> 
	Weather today:
...
<div id="Humidity">
<p style="font-size:14px; color:white; text-shadow:0 0 1px black;"> Humidity:
...
var link2 = "https://query.yahooapis.com/v1/public/yql?q=select * from weather.forecast where woeid in (SELECT woeid FROM geo.places WHERE text='("+lat+","+lon+")') and u ='c'&format=json&callback=callbackFunction";
document.write('\x3Cscript type="text/javascript" src="' + link2 + '">\x3C/script>');
</script>
